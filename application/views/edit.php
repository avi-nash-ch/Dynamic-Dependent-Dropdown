...
<body>
    <div class="container pt-2">
        <div class="row ">
            ...
            <form action="" method="post" name="editFrm" id="editFrm">
                <div class="col-md-12">
                    <h3>Edit</h3>
                    <hr>
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" name="name" id="name" class="form-control pb-1" value="<?php echo $user['name'];?>" placeholder="Please enter name">
                        <p class="name_error"></p>
                    </div>

                    <div class="form-group">
                        <label for="" class=" pt-3 pb-2">Email</label>
                        <input type="text" name="email" id="email" class="form-control" value="<?php echo $user['email'];?>" placeholder="Please enter email">
                    ...
                    <div class="form-group">
                        ...
                        <select name="country" id="country" class="form-control">
                            ...
                            if(!empty($countries)){
                                ...
                                ?>
                                    <option <?php echo ($user['country'] == $country['id']) ? 'selected' : '';?>
                        ...
                        <div id="statesBox">
                            <select name="state" id="state" class="form-control">
                                ...
                                if(!empty($states)){
                                    ...
                                    ?>
                                        <option <?php echo ($user['state'] == $state['id']) ? 'selected' : '';?>
                        ...
                        <div id="citiesBox">
                            <select name="city" id="city" class="form-control pb-1">
                                ...
                                if(!empty($cities)){
                                    ...
                                    ?>
                                        <option <?php echo ($user['city'] == $city['id']) ? 'selected' : '';?>
...
$("#editFrm").submit(function(event) {
    ...
    $.ajax({
        url: '<?php echo base_url('home/updateUser/'.$user['id']); ?>',
        type: 'post',
        data: $(this)
    .serializeArray(), //$(this).serializeArray() --- This will show all detail eksath, one by one leke jane ki jrurat nahi padegi
        dataType: 'json',
        success: function(response) {
